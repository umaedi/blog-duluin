...
<div class="content">
	...
	<div class="card">
		<div class="card-header d-flex align-items-center py-0">
			...
			<div class="ms-auto my-auto">
					...
					<div class="dropdown-menu dropdown-menu-end">
						<a href="{{ url('/dashboard/employees/list-all') }}" class="dropdown-item"><i class="ph-circles-four ph-lg me-3"></i> Show Data All</a>
		...
		<table class="table datatable-column-search-inputs" id="datatable-employees" width="100%">
			<thead>
				<tr>
					<th>No.</th>
					<th>Employee Name</th>
	...
	<div class="card">
		<div class="card-header">
			<h5 class="mb-0"><i class="ph-warning me-2"></i> Rejected Employees</h5>
		</div>
				 

		<table class="table" id="datatable-employees-rejected" width="100%">
			<thead>
				<tr>
					<th>No.</th>
					<th>Employee Name</th>
...
<script>
	...
	$('#datatable-employees tbody').on( 'click', '#open', function () {
        var data = table.row( $(this).parents('tr') ).data();
		var id = data['id'];
		window.location.href = BaseUrl+"/dashboard/employees/view/"+id;
    } );
	
	$('#datatable-employees tbody').on( 'click', '#employees', function () {
        var data = table.row( $(this).parents('tr') ).data();
		var id = data['id'];
	...
	var table2 	= $('#datatable-employees-rejected').DataTable( {  
	...
	$('#datatable-employees-rejected tbody').on( 'click', '#open', function () {
