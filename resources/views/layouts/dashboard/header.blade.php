				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						<div class="status-indicator-container">
							<img src="{{ asset('/assets/images/users/'.$data['user']->avatar); }}" class="w-32px h-32px rounded-pill" alt="">
							<span class="status-indicator bg-success"></span>
						</div>
						<span class="d-none d-lg-inline-block mx-lg-2">{{ $data['user']->name }}</span>
					</a>

					<div class="dropdown-menu dropdown-menu-end">
						<a href="{{ url('dashboard/users/profile') }}" class="dropdown-item">
							<i class="ph-user-circle me-2"></i>
							My profile
						</a>
					 
						<div class="dropdown-divider"></div>
						<a href="{{ url('dashboard/setting') }}" class="dropdown-item">
