		...
		{{ csrf_field() }}
			...
			<div class="modal-body">
				<div class="alert alert-info alert-icon-start alert-dismissible">
					...
					<span class="fw-semibold">Disclaimer!</span> Make sure the category name is right.
...
<script>
	...
	$("#form-post").submit(function(event) {
        ...
        if(type == 'update'){
            var path = ServUrl+"/categories/update";
        }else if(type == 'create'){
            var path = ServUrl+"/categories/create";
        }
