<footer>
    ...
    <div class="tp-footer__pl-pr grey-bg-2 tp-footer-style-2">
       <div class="tp-footer__area pt-50 tp-footer__tp-border-bottom">
          <div class="container">
             <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                   <div class="tp-footer__widget footer-widget-2 footer-col-2-1">
                      <div class="tp-footer__logo mb-25">
                         <a href="index.html">
                            <img src="{{ asset('img') }}/logo/logo-Duluin-footer.png" alt="" width="75%">
                         </a>
                      </div>
                      <div class="tp-footer__contact-info">
                         <a href="#"
                            target="_blank">Jl. Gading Kirana Timur A11/15, Kelapa Gading Barat, Kelapa Gading, Jakarta Utara, Jakarta, 14240</a>
                         <ul>
                            <li>
                               <span>
                               ...
                               <a class="first-child" href="tel:+806(000)8899">081317165154</a>
                            </li>
                            <li>
                               <span>
                               ...
                               <a href="mailto:hello@duluin.com">hello@duluin.com</a>
                            </li>
                         </ul>
                      </div>
                   </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                   <div class="tp-footer__widget footer-widget-2 footer-col-2-2">
                      <h4 class="tp-footer__widget-title">Produk</h4>
                      <div class="tp-footer__content">
                         <ul>
                            <li><a href="https://gajian.duluin.com">Duluin Gajian</a></li>
                            <li><a href="/coming-soon">Duluin Pencairan</a></li>
                            <li><a href="/coming-soon">Duluin Pengadaan</a></li>
                            <li><a href="/coming-soon">Duluin HRIS</a></li>
                            <li><a href="/coming-soon">Duluin Tagihan</a></li>
                            <li><a href="/coming-soon">Duluin Cuan</a></li>
                         </ul>
                      </div>
                   </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                   <div class="tp-footer__widget footer-widget-2 footer-col-2-3">
                      <h4 class="tp-footer__widget-title">Halaman</h4>
                      <div class="tp-footer__content">
                         <ul>
             ...
             <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6  d-none d-md-block">
                   <div class="tp-copyright__text tp-copyright__text-2 text-center">
                      <span>Copyright © 2023 PT. Rasa Aksata Nusantara. All Rights Reserved.</span>
                   </div>
                </div>
             </div>
          </div>
