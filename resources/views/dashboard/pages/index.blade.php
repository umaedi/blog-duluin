...
<div class="content">
	...
	<div class="card">
		<div class="card-header d-flex align-items-center py-0 ">
			...
			<div class="ms-3">
				<a type="button" href="{{ url('dashboard/pages/create') }}" class="btn btn-indigo"><i class="ph-plus me-1"></i> Create New</a>
			</div>
			<div class="ms-2">
				<div class="wmin-250">
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="row mb-2">
					...
					<div class="col-lg-8">
						<input id="search" type="search" class="form-control" placeholder="Search Title..." aria-controls="datatable-pages">
		...
		<div class="table-responsive">
			<table class="small table text-nowrap datatable-column-search-inputs" id="datatable-pages" width="100%">
				<thead>
					<tr>
						<th>No.</th>
						<th>Title</th>
...
$(document).ready(function() {
	...
	let table2 = '';
	function loadNews(){
	  table  	= $('#datatable-pages').DataTable( {  
	...
	$('#datatable-pages tbody').on( 'click', '#open', function () {
        var data = table.row( $(this).parents('tr') ).data();
		var id = data['id'];	
			window.location.href = BaseUrl+"/dashboard/pages/detail/"+id;
    });
	
	$('#datatable-pages tbody').on( 'click', '#update', function () {
        var data = table.row( $(this).parents('tr') ).data();
		var id = data['id'];	
			window.location.href = BaseUrl+"/dashboard/pages/update/"+id;
    });
	
	$('#datatable-pages tbody').on( 'click', '#approved', function () {
        var data = table.row( $(this).parents('tr') ).data();
	...
	$('#switchStatus').on( 'change',function () {
		...
		if ( ! $.fn.DataTable.isDataTable( '#datatable-pages' ) ) {
			loadNews();
		}else{
